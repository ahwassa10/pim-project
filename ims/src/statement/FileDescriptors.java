...
final class FileDescriptors {
    ...
    public static String from(String qualifierKey, String holderKey) {
    ...
    public static String getHolder(String fileDescriptor) {
    ...
    public static String getQualifier(String fileDescriptor) {
        int endIndex = 0;
    ...
    public static boolean isValid(String test_descriptor) {
        return test_descriptor != null && 
               FILE_DESCRIPTOR_PATTERN.matcher(test_descriptor).matches();
    }
    
    public String requireValidDescriptor(String test_descriptor) {
