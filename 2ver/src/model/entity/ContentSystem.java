...
public final class ContentSystem {
    ...
    private ContentEntity buildEntity(UUID contentID) {
        return new ContentEntity() {
            ...
            private final String name = nameMetadata.viewValues().get(contentID).certainly().any();
            private final String description = descriptionMetadata.viewValues().get(contentID).certainly().any();
